...
const ReceiptScanner = ({onScanComplete}) => {
    ...
    const handleReceiptScan=async(file)=>{
        if(file.size> 5*1024*1024){
            toast.error("File size should be less than be 5MB")
            return 
        }
    ...
    return (
        <div>
            ...
            <Button type="button" variant='outline' className='w-full h-10 bg-gradient-to-br from-yellow-400  via-orange-400 to-pink-500 animate-gradient hover:opacity-90 transition-opacity text-white hover:text-white'
